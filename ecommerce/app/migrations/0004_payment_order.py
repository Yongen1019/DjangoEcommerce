    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('razerpay_order_id', models.CharField(blank=True, max_length=100, null=True)),
                ('razerpay_payment_status', models.CharField(blank=True, max_length=100, null=True)),
                ('razerpay_payment_id', models.CharField(blank=True, max_length=100, null=True)),
